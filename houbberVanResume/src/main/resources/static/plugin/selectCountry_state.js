...
$(function() {
  ...
  $("#country option").css("background","rgba(88, 136, 192,0.6)");
  $("#country option").css("color","#333");
});
...
function populateStates(countryElementId, stateElementId) {
    ...
    for (var i = 0; i < state_arr.length; i++) {
        ...
        $("#state option").css("background","rgba(88, 136, 192,0.6)");
  		$("#state option").css("color","#333");
    }
}